...
const RezervareNouaATV1 = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    console.log("Tipul produsului este: " + newReservation.atv1Model)
    ...
    try {
        await axios.post('http://localhost:3001/rezervari/atv1', newReservation);
  ...
  return (
    ...
    <div className='form-group'>
          <label htmlFor='atv1Model'>Model Vehicul</label>
          <select
            name='atv1Model'
            id='atv1Model'
            value={product}
          ...
          >
            <option value='ATV1'>ATV CF Moto CForce 450L</option>
...
export default RezervareNouaATV1;