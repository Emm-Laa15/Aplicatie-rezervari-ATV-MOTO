...
const RezervareNouaATV2 = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    console.log("Tipul produsului este: " + newReservation.atv2Model)
    ...
    try {
        await axios.post('http://localhost:3001/rezervari/atv2', newReservation);
  ...
  return (
    ...
    <div className='form-group'>
          <label htmlFor='atv2Model'>Model Vehicul</label>
          <select
            name='atv2Model'
            id='atv2Model'
            value={product}
...
export default RezervareNouaATV2;