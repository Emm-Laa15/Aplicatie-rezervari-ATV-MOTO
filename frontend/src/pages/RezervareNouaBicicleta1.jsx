...
const RezervareNouaBicicleta1 = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    console.log("Tipul produsului este: " + newReservation.bicicleta1Model);
    ...
    try {
      await axios.post('http://localhost:3001/rezervari/bicicleta1', newReservation);
      ...
      {success ? (
        ...
        <form onSubmit={handleSubmit}>
          <div className='form-group'>
            <label htmlFor='bicicleta1Model'>Model Vehicul</label>
            <select
              name='bicicleta1Model'
              id='bicicleta1Model'
              value={product}
              onChange={event => setProduct(event.target.value)}
            >
              <option value='Bicicleta1'>Bicicleta electrica Neuzer E-City Zagon</option>
            </select>
          </div>
          <div className='form-group'>
...
export default RezervareNouaBicicleta1;
